...
/files/:id/metadata/global/boxSkillsCards`](/reference/post_files_id_metadata_global_boxSkillsCards)
...
[update_skills]: /reference/put_files_id_metadata_global_boxSkillsCards