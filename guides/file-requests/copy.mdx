...
related_resources:
  - file_request
---
To create a copy of an existing [template](/guides/file-requests/template) file
...
For a file request, please [check our guide](/guides/file-requests/template)
...
[`POST /file-requests/:id/copy`](/reference/post_file_requests_id_copy) API.
