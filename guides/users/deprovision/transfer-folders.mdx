...
* Using the direct [transfer owned folders](/reference/put_users_id_folders_0) API, which will move all content from one user directly to another.
...
The [transfer owned folders endpoint](/reference/put_users_id_folders_0) is
...
[collaboration endpoint](/reference/post_collaborations) to change the
...
[add collaboration endpoint](/reference/post_collaborations).
...
[get collaboration endpoint](/reference/get_collaborations_id). Capture the
collaboration ID.
...
[delete collaboration endpoint](/reference/delete_collaborations_id).
