...
<Card href="/guides/skills" arrow title="Start building a Custom Skill"/>
...
<Card href="/guides/authorization/custom-skill-approval" arrow title="Learn how to approve Custom Skills"/>
