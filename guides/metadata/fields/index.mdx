...
|                                                   |                                               |
|---------------------------------------------------|-----------------------------------------------|
| [`string`](/guides/metadata/fields/string)            | A text field                                  |
| [`float`](/guides/metadata/fields/float)              | A numeric input field                         |
| [`date`](/guides/metadata/fields/date)                | A date picker field                           |
| [`enum`](/guides/metadata/fields/enum)                | A dropdown list for selecting a single value         |
| [`multiSelect`](/guides/metadata/fields/multi-select) | A dropdown list for selecting multiple values |
