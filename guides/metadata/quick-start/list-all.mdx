...
A few [global templates](/reference/get_metadata_templates_global) are available to all
customers.
...
within your enterprise](/reference/get_metadata_templates_enterprise) to hold data
