...
[metadata query guides](/guides/metadata/queries), or the associated [endpoint
reference](/reference/post_metadata_queries_execute_read).

<Card href="/guides/metadata/queries/syntax" arrow title="Learn more about the query syntax"/>
...
<Card href="/guides/metadata/queries/pagination" arrow title="Learn more about paginating query results"/>