...
* [`GET /enterprise/:id/device_pinners`](/reference/get-enterprises-id-device-pinners): Retrieves all the device pins within an enterprise.
* [`GET /device_pinners/:id`](/reference/get-device-pinners-id): Retrieves information about an individual device pin.
* [`DELETE /device_pinners/:id`](/reference/delete-device-pinners-id): Deletes an individual device pin.
