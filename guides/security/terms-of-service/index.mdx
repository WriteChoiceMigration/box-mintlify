...
* [`GET /terms_of_services/:id`](/reference/get-terms-of-services-id): To get the information for a specific Terms of Service
* [`GET /terms_of_services`](/reference/get-terms-of-services): To get a list of all the Terms of Services used within an enterprise, either for managed or external users.
* [`POST /terms_of_services`](/reference/post-terms-of-services): To create Terms of Service settings for either an external or managed user.
* [`PUT /terms_of_services/:id`](/reference/put-terms-of-services-id):
...
[euserstatuses]: /reference/get-terms-of-service-user-statuses
[euserstatuses_put]: /reference/put-terms-of-service-user-statuses-id
[euserstatuses_post]: /reference/post-terms-of-service-user-statuses
