...
<Note>
  Explore the [reference documentation](/reference/get_search) to learn more
...
[search operators](/guides/search/query-operators), including
...
<Card href="/guides/search/query-operators" arrow title="Learn more about using logical operators"/>
...
<Card href="/guides/search/indexing" arrow title="Learn more about the Box search index"/>
...
<Card href="/guides/metadata/queries/comparison" arrow title="Learn more about the metadata query API"/>

[mdq]: /guides/metadata/queries
[mdq_api]: /reference/post_metadata_queries_execute_read
