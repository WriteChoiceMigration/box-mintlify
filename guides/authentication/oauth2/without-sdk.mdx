...
It is possible to [act as another user](/guides/authentication/oauth2/as-user)
...
[auth]: /reference/get-authorize
[ci]: /reference/get-authorize/#param-client_id
[re]: /reference/get-authorize/#param-redirect_uri
[co]: /reference/get-authorize/#param-response_type
[st]: /reference/get-authorize/#param-state
[thirty]: /guides/api-calls/permissions-and-errors/expiration
[at]: /reference/post-oauth2-token
[apic]: /guides/api-calls
