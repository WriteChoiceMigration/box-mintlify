...
[User Types](https://developer.box.com/platform/user-types) for more details.

## User Access Tokens with SDKs

To create a Box SDK client that authenticates as a specific user, follow the
steps described in the [JWT with SDK guide](/guides/authentication/jwt/with-sdk),
...
[JWT without SDK guide](/guides/authentication/jwt/without-sdk) but instead of creating
