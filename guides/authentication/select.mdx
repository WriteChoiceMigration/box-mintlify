...
<Card href="/guides/applications/app-types/select" arrow title="Learn how to select the application type for your app"/>
...
<Card href="/guides/authentication/oauth2" arrow title="Learn about client-side authentication with OAuth 2.0"/>
...
<Card href="/guides/authentication/jwt" arrow title="Learn about server-side authentication with JWT"/>
...
<Card href="/guides/authentication/client-credentials" arrow title="Learn about server-side authentication with Client Credentials Grant"/>
...
<Card href="/guides/authentication/app-token" arrow title="Learn about server-side authentication with App Tokens"/>
