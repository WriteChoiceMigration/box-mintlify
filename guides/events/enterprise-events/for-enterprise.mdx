...
a call to the [`GET /events`](/reference/get_events) API with the `stream_type` set to
...
[shield-events]: /guides/events/event-triggers/shield-alert-events
