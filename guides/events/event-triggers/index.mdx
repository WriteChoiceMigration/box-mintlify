...
items, or other resources. The response of the [`GET /events`](/reference/get_events) 
...
representation of the [user resource](/reference/resources/user).
...
[event source resource](/reference/resources/event-source).
