---
title: "Connect SSO identities to app users"
related_endpoints:
  - post_users
---
...
* Email association is only viable for [managed users](https://developer.box.com/platform/user-types/#managed-users). [App users](https://developer.box.com/platform/user-types/#app-user) are automatically assigned an email address by Box, meaning that you cannot assign the `login` to be the email from the SSO service.
...
* Only the [managed users](https://developer.box.com/platform/user-types/#managed-users) type is being used, not [app users](https://developer.box.com/platform/user-types/#app-user).
