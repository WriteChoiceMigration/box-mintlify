...
of [step 2](/guides/sso-identities-and-app-users/connect-okta-to-app-users/configure-okta).
<br/>
...
* [User provisioning](/guides/users/provision) best practices for advanced user folder architecture setup.
* [User deprovisioning](/guides/users/deprovision) best practices cleaning up inactive users and transferring user content to another account.
* [Uploading content](/guides/uploads) into Box, including running preflight checks and large file (chunked) uploading.

[step1]: /guides/sso-identities-and-app-users/connect-okta-to-app-users/scaffold-application-code
[step2]: /guides/sso-identities-and-app-users/connect-okta-to-app-users/configure-okta
[step3]: /guides/sso-identities-and-app-users/connect-okta-to-app-users/configure-box
[step4]: /guides/sso-identities-and-app-users/connect-okta-to-app-users/logging-into-app
[step5]: /guides/sso-identities-and-app-users/connect-okta-to-app-users/find-or-create-box-users
[step6]: /guides/sso-identities-and-app-users/connect-okta-to-app-users/run-the-app
