---
title: "Find or create Box app users"
sidebarTitle: 5. Find or create Box app users
type: quick-start
...
[scoped for that user](/guides/authentication/jwt/user-access-tokens) to make Box
