...
1. [Created a new iOS app](/guides/mobile/ios/quick-start/create-ios-app) in Xcode.
2. [Installed the iOS SDK](/guides/mobile/ios/quick-start/install-ios-sdk) into your project.
3. [Configured a Box App](/guides/mobile/ios/quick-start/configure-box-app) so that the iOS SDK can access the Box API.
4. [Made your first API call](/guides/mobile/ios/quick-start/make-api-call) to the Box API with the iOS SDK.
...
* [Token Downscoping](/guides/authentication/tokens/downscope): In this quick start guide you used a developer token to make your first call. To implement a scalable solution you should have a server-side solution to generate downscoped tokens to replace that implementation.
