...
- [List items for a folder](/reference/get_folders_id_items)
- [List a file's collaborations](/reference/get-files-id-collaborations)
- [List all webhooks for a user](/reference/get-webhooks)
- [List all users in an enterprise](/reference/get-users)
- [List all items in the trash](/reference/get-folders-trash-items)
