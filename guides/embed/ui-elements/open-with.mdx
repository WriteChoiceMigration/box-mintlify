...
Currently, the element only supports [App Users](https://developer.box.com/platform/user-types)
for authentication.

## Installation

[Learn how to install](/guides/embed/ui-elements/installation) Box UI elements
...
[`PUT /users/:id`](/reference/put-users-id) endpoint.
...
available [here](/guides/authorization/platform-app-approval).
...
- A valid [Service Account](https://developer.box.com/platform/user-types/#service-account) Access Token.
...
{/* i18n-disable localize-links */}
[custom-domains]: /guides/embed/ui-elements/custom-domains
{/* i18n-enable localize-links */}
