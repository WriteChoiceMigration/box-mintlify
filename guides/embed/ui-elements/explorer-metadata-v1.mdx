---
title: "Content Explorer - metadata view v1"
rank: 5
related_endpoints:
...
[creating-templates-api]: /guides/metadata/templates/create
...
[box-app]: /guides/applications/app-types
...
[get-template]: /reference/metadata/templates/get/#get-a-metadata-template-by-name
[metadata-query]: /guides/metadata/queries
[get-id]: /reference/get-metadata-templates-id-id-schema/
[field-key]: /reference/post-metadata-templates-schema/#param-fields-key
[display-name]: /reference/post-metadata-templates-schema/#param-fields-displayName
[source]: /guides/metadata/scopes
