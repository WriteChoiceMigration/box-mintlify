...
<Card href="/guides/embed/ui-elements/preview" arrow title="Learn more about Content Preview"/>
...
[Learn more about browser support](/guides/embed/ui-elements/browser) for Box UI
element.
...
[Downscoping](/guides/authentication/tokens/downscope) to appropriately
...
Elements](/guides/embed/ui-elements/scopes).
...
Content Preview](/guides/embed/ui-elements/preview) for more details on how to
