...
<Note>
  ...
  [Get File Information endpoint](/reference/get_files_id) and request
...
the Box [UI Preview Element](/guides/embed/ui-elements/preview).

To set up the Preview Element, start by installing the required components.

<Card href="/guides/embed/ui-elements/installation" arrow title="Install Box Elements and Preview"/>
...
<Warning>
  ...
  code. See
  [best practices for downscoping](/guides/embed/box-view/best-practices#use-downscoped-tokens).
</Warning>
