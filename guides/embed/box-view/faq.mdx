...
[here](/guides/embed/box-view/setup).
</Accordion>

<Accordion title="Which Preview method, Embed Link or UI Element, is right for me?">

Please follow our guide [here](/guides/embed/box-view/create-preview) to choose
...
* Full annotations support is available for mobile via the [Content Preview UI Element](/guides/embed/ui-elements/preview), which leverages Box Annotations.
...
[Box Representations](/guides/representations) let you get the digital assets
...
[CORS guide](/guides/security/cors) for more information.
</Accordion>
...
[Preview UI Element](/guides/embed/ui-elements/logo).
</Accordion>
</AccordionGroup>
