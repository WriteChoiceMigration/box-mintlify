...
<Expandable>
  ...
  基本テキストに対するAIエージェントで使用されるモデル。特定のモデル値については、[利用可能なモデルのリスト](/guides/box-ai/supported-models/)を参照してください。
  </ParamField>
...
<Expandable>
  ...
  スプレッドシートに対するAIエージェントで使用されるモデル。特定のモデル値については、[利用可能なモデルのリスト](/guides/box-ai/supported-models/)を参照してください。
  </ParamField>
