...
メタデータクエリと一致したファイルおよびフォルダのページ。

<ParamField body="entries" type="object[ファイル (Full)/フォルダ (Full)]array">
検索語句と一致するファイルやフォルダのMini版の表示。
