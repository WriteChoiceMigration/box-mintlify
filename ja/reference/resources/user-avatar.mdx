...
BoxアプリケーションにアップロードされたアバターへのURLを保持するリソース。

<ParamField body="pic_urls" type="object">
ユーザーのアバターのURLを示すオブジェクトを表します。

<Expandable>
  <ParamField body="large" type="string">
  例 `https://app.box.com/index.php?rm=pic_storage_auth&pic=euks
