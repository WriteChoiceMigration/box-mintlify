...
値は常に`recent_item`になります。
</ParamField>

<ParamField body="interacted_at" type="string(date-time)">
例 `2018-04-13T13:53:23-07:00`

直近のやり取りの日時。
</ParamField>

<ParamField body="interaction_shared_link" type="string">
例 `https://www.box.com/shared/static/rh935iit6ewrmw0unyul.jpeg`

項目へのアクセスが共有リンクを通じて行われた場合は、その共有リンクがここに入り、そうでない場合はnullになります。
</ParamField>

<ParamField body="interaction_type" type="string">
例 `item_preview`

ユーザーがこの項目に対して最近実行したアクセスのタイプ。

次の値のいずれか1つ: `item_preview`,`item_upload`,`item_comment`,`item_open`,`item_modify`
</ParamField>

<ParamField body="item" type="ファイル (Full)/フォルダ (Full)/ウェブリンクobject">
最近アクセスした項目。
</ParamField>
