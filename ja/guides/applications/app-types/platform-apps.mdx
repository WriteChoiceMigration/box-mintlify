...
<Card href="/ja/guides/authentication/select" title="認証方法の詳細を確認する"/>
...
<Card href="/ja/guides/authorization/platform-app-approval" title="Platformアプリの承認方法を確認する"/>
...
[users]: https://ja.developer.box.com/platform/user-types/#managed-users
