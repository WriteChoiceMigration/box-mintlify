---
title: "Signテンプレートを使用した署名リクエストの作成"
rank: 6
related_endpoints:
  - get-sign-templates
...
[parentfolder]: /ja/guides/box-sign/create-sign-request#parent-folder

[signers]: /ja/guides/box-sign/create-sign-request#signers

[template]: /ja/reference/get-sign-templates#response-example
