...
* [フォルダ内の項目を取得](/ja/reference/get_folders_id_items)
* [ファイルのコラボレーションのリストを取得](/ja/reference/get-files-id-collaborations)
* [ユーザーのすべてのWebhookのリストを取得](/ja/reference/get-webhooks)
* [社内のすべてのユーザーのリストを取得](/ja/reference/get-users)
* [ごみ箱にあるすべての項目のリストを取得](/ja/reference/get-folders-trash-items)
