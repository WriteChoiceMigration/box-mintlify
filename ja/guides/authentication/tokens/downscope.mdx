...
| `box_shared_link`    | Box上のファイルまたはフォルダの[共有リンク](/ja/guides/shared-links)URL (省略可)。パスワード保護されているリンクはサポートされていません。このオプションは、`resource`オプションに追加して使用することができません。また、ウェブリンクに作成された共有リンクを指定することもできません。 |
...
[scopes_down]: /ja/guides/api-calls/permissions-and-errors/scopes/#scopes-for-downscoping
