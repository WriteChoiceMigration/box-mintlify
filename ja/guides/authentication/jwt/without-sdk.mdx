...
このトークンの使用方法を確認するには、[APIコールの実行](/ja/guides/api-calls)に関するガイドを参照してください。
...
`as-user`ヘッダーを使用するか[ユーザーアクセストークン](/ja/guides/authentication/jwt/user-access-tokens)をリクエストして、[別のユーザーとして処理を実行](/ja/guides/authentication/oauth2/as-user)できます。
...
[configfile]: /ja/guides/authentication/jwt/jwt-setup/#jwt-keypair
