...
<Card href="/ja/guides/applications/app-types/select" title="アプリケーションの種類の選択方法を確認する"/>
...
<Card href="/ja/guides/authentication/oauth2" title="OAuth 2.0を使用したクライアント側認証を確認する"/>
...
<Card href="/ja/guides/authentication/jwt" title="JWTを使用したサーバー側認証を確認する"/>
...
<Card href="/ja/guides/authentication/client-credentials" title="クライアント資格情報許可を使用したサーバー側認証を確認する"/>
...
<Card href="/ja/guides/authentication/app-token" title="アプリトークンを使用したサーバー側認証を確認する"/>
...
[custom-skill]: /ja/guides/applications/app-types/custom-skills

[la-app]: /ja/guides/applications/app-types/limited-access-apps
