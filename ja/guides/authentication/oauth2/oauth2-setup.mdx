...
<Card href="/ja/guides/authentication/oauth2" title="OAuth 2.0認証のしくみを確認する"/>
...
<Frame>![アプリ名のフォーム](../images/app-scopes.png)</Frame>
...
<Frame>![アプリ名のフォーム](../images/app-cors.png)</Frame>
...
[url-redirect]: /ja/reference/get-authorize/#param-redirect_uri
