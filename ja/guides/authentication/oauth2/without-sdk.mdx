...
`as-user`ヘッダーを使用して、[別のユーザーとして処理を実行](/ja/guides/authentication/oauth2/as-user)できます。
...
<Card href="/ja/reference/get-authorize" title="承認URLの詳細を確認する"/>
...
[auth]: /ja/reference/get-authorize

[ci]: /ja/reference/get-authorize/#param-client_id

[re]: /ja/reference/get-authorize/#param-redirect_uri

[co]: /ja/reference/get-authorize/#param-response_type

[st]: /ja/reference/get-authorize/#param-state

[thirty]: /ja/guides/api-calls/permissions-and-errors/expiration

[at]: /ja/reference/post-oauth2-token

[apic]: /ja/guides/api-calls
