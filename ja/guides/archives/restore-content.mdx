...
[Update parent user id of file]: /ja/reference/put-files-id/#param-parent-user_id

[Update folder]: /ja/reference/put-folders-id

[Update parent id of folder]: /ja/reference/put-folders-id/#param-parent-id

[Update parent user id of folder]: /ja/reference/put-folders-id/#param-parent-user_id
