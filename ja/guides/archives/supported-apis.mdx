...
[Upload file]: /ja/reference/post-files-content

[Download file]: /ja/reference/get-files-id-content

[Download zip]: /ja/reference/post-zip-downloads

[Create folder within archive]: /ja/reference/post-folders

[Get file details]: /ja/reference/get-files-id

[Get folder details]: /ja/reference/get-folders-id

[List folder items]: /ja/reference/get-folders-id-items

[Copy file]: /ja/reference/post-files-id-copy

[Copy folder]: /ja/reference/post-folders-id-copy

[Create metadata on file]: /ja/reference/post-files-id-metadata-id-id

[View metadata on file]: /ja/reference/get-files-id-metadata-id-id

[List metadata on file]: /ja/reference/get-files-id-metadata

[Update metadata on file]: /ja/reference/put-files-id-metadata-id-id

[Delete metadata on file]: /ja/reference/delete-files-id-metadata-id-id

[Create classification label on file]: /ja/reference/post-files-id-metadata-enterprise-securityClassification-6VMVochwUWo

[View classification label on file]: /ja/reference/get-files-id-metadata-enterprise-securityClassification-6VMVochwUWo

[Update classification label on file]: /ja/reference/put-files-id-metadata-enterprise-securityClassification-6VMVochwUWo

[Delete classification label on file]: /ja/reference/delete-files-id-metadata-enterprise-securityClassification-6VMVochwUWo
