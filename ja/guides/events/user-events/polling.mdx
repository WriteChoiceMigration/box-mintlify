...
---
Boxアカウントでアクティビティのリアルタイム通知を取得するために、[`OPTIONS /events`](/ja/reference/options_events) APIのLong polling機能を使用できます。
...
Long pollingを使用するには、まず、リクエストを[`OPTIONS /events`](/ja/reference/options_events) APIに送信し、Long polling URLを取得します。
