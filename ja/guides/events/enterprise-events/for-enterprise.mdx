...
---
Enterprise Eventを取得するには、`stream_type`を`admin_logs`または`admin_logs_streaming`に設定して[`GET /events`](/ja/reference/get_events) APIを呼び出します。
...
[shield-events]: /ja/guides/events/event-triggers/shield-alert-events
