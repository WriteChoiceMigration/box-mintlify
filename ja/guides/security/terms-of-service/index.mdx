...
* [`GET /terms_of_services/:id`](/ja/reference/get-terms-of-services-id): 特定のサービス利用規約の情報を取得します。
* [`GET /terms_of_services`](/ja/reference/get-terms-of-services): 管理対象ユーザーまたは外部ユーザー用に、企業内で使用されているすべてのサービス利用規約のリストを取得します。
* [`POST /terms_of_services`](/ja/reference/post-terms-of-services): 外部ユーザーまたは管理対象ユーザー用にサービス利用規約の設定を作成します。
* [`PUT /terms_of_services/:id`](/ja/reference/put-terms-of-services-id): 特定のサービス利用規約の設定を更新します。
...
[euserstatuses]: /ja/reference/get-terms-of-service-user-statuses

[euserstatuses_put]: /ja/reference/put-terms-of-service-user-statuses-id

[euserstatuses_post]: /ja/reference/post-terms-of-service-user-statuses
