...
* [`GET /enterprise/:id/device_pinners`](/ja/reference/get-enterprises-id-device-pinners): 会社内のすべてのデバイスピンを取得します。
* [`GET /device_pinners/:id`](/ja/reference/get-device-pinners-id): 個々のデバイスピンに関する情報を取得します。
* [`DELETE /device_pinners/:id`](/ja/reference/delete-device-pinners-id): 個々のデバイスピンを削除します。
