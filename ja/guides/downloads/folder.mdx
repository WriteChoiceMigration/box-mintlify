---
title: "SDKを使用したフォルダ内のすべてのファイルのダウンロード"
rank: 5
related_endpoints:
...
ZIPアーカイブをダウンロードするには、[こちら](/ja/guides/downloads/zip-archive)のガイドに従ってください。
...
認証に関するガイドにある[ユーザータイプ](https://developer.box.com/platform/user-types)の詳細をご覧ください。
