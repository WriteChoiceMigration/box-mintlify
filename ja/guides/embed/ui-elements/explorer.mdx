...
NPMまたはBox CDN経由でBox UI Elementsをインストールする方法は、[こちら](/ja/guides/embed/ui-elements/installation)を参照してください。
...
[templates]: /ja/guides/metadata/templates
...
[get-template]: /ja/guides/metadata/templates/get/#get-a-metadata-template-by-name
...
[explorer-metadata]: /ja/guides/embed/ui-elements/explorer-metadata-v2
