...
<Frame>![メタデータビュー](./images/explorer-metadata-v2.png)</Frame>
...
// You can use this endpoint to get all needed values: /ja/reference/get-metadata-templates-id-id-schema/
...
   // /ja/reference/post-metadata-queries-execute-read/
...
<Frame>![行の選択](./images/explorer-select.png)</Frame>
...
<Frame>![メタデータの編集](./images/explorer-edit.png)</Frame>
...
<Frame>![グリッドビュー](./images/explorer-grid.png)</Frame>
...
[content-explorer]: /ja/guides/embed/ui-elements/explorer/
...
[developer-token]: /ja/guides/authentication/tokens/developer-tokens/

[metadata-guides]: /ja/guides/metadata/templates/

[md-queries]: /ja/reference/post-metadata-queries-execute-read/

[apply-templates]: https://support.box.com/hc/en-us/articles/360044196173-Using-Metadata

[installation]: /ja/guides/embed/ui-elements/installation
