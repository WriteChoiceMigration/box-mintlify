...
<Card href="https://www.npmjs.com/package/box-ui-elements" title="NPMウェブサイトの詳細を確認する"/>
...
| Element                                                            | バージョン     | ファイル                                                                                                                                                                         |
| ------------------------------------------------------------------ | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [コンテンツエクスプローラ](/ja/guides/embed/ui-elements/explorer)                     | `23.0.0`  | CSS [`https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/explorer.css`](https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/explorer.css)                           |
...
| [Content Open With](/ja/guides/embed/ui-elements/open-with)               | `23.0.0`  | CSS [`https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/openwith.css`](https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/openwith.css)                           |
...
| [Content Picker](/ja/guides/embed/ui-elements/picker)                     | `23.0.0`  | CSS [`https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/picker.css`](https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/picker.css)                               |
...
| [Content Sidebar](/ja/guides/embed/ui-elements/sidebar)                   | `23.0.0`  | CSS [`https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/sidebar.css`](https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/sidebar.css)                             |
...
| [コンテンツアップローダー](/ja/guides/embed/ui-elements/uploader)                     | `23.0.0`  | CSS [`https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/uploader.css`](https://cdn01.boxcdn.net/platform/elements/23.0.0/en-US/uploader.css)                           |
...
| [コンテンツプレビューSDK](/ja/guides/embed/ui-elements/preview)                     | `2.106.0` | CSS [`https://cdn01.boxcdn.net/platform/preview/2.106.0/en-US/preview.css`](https://cdn01.boxcdn.net/platform/preview/2.106.0/en-US/preview.css)                             |
...
<Card href="/ja/guides/authentication/select" title="アプリケーションの認証方法を確認する"/>
