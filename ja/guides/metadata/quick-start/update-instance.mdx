...
<Card href="/ja/guides/metadata/instances/update" title="インスタンスの更新の詳細を確認する"/>
...
<Card href="/ja/guides/metadata/instances/update" title="すべての操作の詳細を確認する"/>
