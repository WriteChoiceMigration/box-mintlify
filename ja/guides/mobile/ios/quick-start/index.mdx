...
1. Xcodeで[新しいiOSアプリを作成](/ja/guides/mobile/ios/quick-start/create-ios-app)します。
2. プロジェクトに[iOS SDKをインストール](/ja/guides/mobile/ios/quick-start/install-ios-sdk)します。
3. iOS SDKからBox APIにアクセスできるように[Boxアプリを設定](/ja/guides/mobile/ios/quick-start/configure-box-app)します。
4. iOS SDKを使用してBox APIに対する[APIコールを実行](/ja/guides/mobile/ios/quick-start/make-api-call)します。
