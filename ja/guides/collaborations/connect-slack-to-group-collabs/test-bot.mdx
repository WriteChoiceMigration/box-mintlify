...
[next-steps-shared-link]: /ja/guides/shared-links/create-or-update

[next-steps-retention-policy]: /ja/reference/post-retention-policies

[next-steps-policy-assign]: /ja/reference/post-retention-policy-assignments

[next-steps-comment]: /ja/reference/post-comments
