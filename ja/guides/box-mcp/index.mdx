...
<CustomCard icon="database" title="リモートBox MCPサーバー" href="/ja/guides/box-mcp/remote"
...
<CustomCard icon="database" title="セルフホストBox MCPサーバー" href="/ja/guides/box-mcp/self-hosted"
