...
---
[`GET /search`](/ja/reference/get_search) APIでは、APIによって返された結果を絞り込むのに役立つさまざまなクエリ演算子がサポートされています。
...
<Card href="https://support.box.com/hc/en-us/articles/360043696314-Search-for-Files-Folders-and-Content" title="Boxコミュニティの記事で、Boxでの検索に関する最新情報を確認する"/>
