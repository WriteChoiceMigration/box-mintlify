...
source_url: >-
  https://github.com/box/developer.box.com/blob/main/content/guides/uploads/chunked/folder.md
...
最後に、ファイルサイズが20 MBを超える場合、[分割アップロード][chunked]機能を使用して、大きいファイルのアップロードの信頼性を高めます。

[preflight]: /ja/guides/uploads/check
