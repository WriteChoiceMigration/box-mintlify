...
<Expandable>
  ...
  The model used for the AI agent for basic text. For specific model values, see the [available models list](/guides/box-ai/supported-models/).
  </ParamField>
...
<ParamField body="basic_image_multi" type="object">
AI agent processor used to handle basic text.
...
<ParamField body="basic_text_multi" type="object">
AI agent processor used to handle basic text.
...
<ParamField body="long_text_multi" type="object">
AI agent processor used to to handle longer text.
...
<ParamField body="spreadsheet" type="object">
...
<Expandable>
  ...
  The model used for the AI agent for spreadsheets. For specific model values, see the [available models list](/guides/box-ai/supported-models/).
  </ParamField>
