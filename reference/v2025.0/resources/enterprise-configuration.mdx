...
Value is always `enterprise_configuration`
</ParamField>

<ParamField body="content_and_sharing" type="Enterprise configuration content and sharingobject">
The enterprise configurations for the content and sharing category.
</ParamField>

<ParamField body="security" type="Enterprise configuration securityobject">
The enterprise configurations for the security category.
</ParamField>

<ParamField body="shield" type="Enterprise configuration shieldobject">
The enterprise configurations for the shield category. If shield is turned off for given enterprise, the response will be 404.
</ParamField>

<ParamField body="user_settings" type="Enterprise configuration user settingsobject">
The enterprise configurations for the user settings category.
</ParamField>
